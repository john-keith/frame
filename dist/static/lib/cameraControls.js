export default function Controls(camera, container,height){
	this.centerX=0;
	this.centerY=0;
	this.centerZ=0;
...
Controls.prototype.buttons= function(e){
	...
	let move=this.viewingHeight/6000;
	if(!this.locked){
    switch(e.which) {
        case 37: // left
        this.targetZ+=move;
...
Controls.prototype.update= function(){
	...
	this.camera.position.x = this.centerX + this.viewingHeight * Math.sin( -this.rotationX )* Math.cos( -this.rotationZ );         
	this.camera.position.y = this.centerY + this.viewingHeight * Math.sin( -this.rotationX)* Math.sin( -this.rotationZ );
	this.camera.position.z = this.centerZ + this.viewingHeight * Math.cos( -this.rotationX);
